var _api_root = 'https://sy.takeus.cn/addons/zjhj_mall/core/web/index.php?store_id=1&r=api/';
var api = {
  ...
  default: {
    ...
    upload_image_order: _api_root + "default/upload-image-with-order",
  ...
  photographer: {
    level_list: _api_root + 'photographer/photographer-level',
    apply: _api_root + 'photographer/apply',
    info: _api_root + 'photographer/info',
    area_list: _api_root + "photographer/area-list",
    my_info: _api_root + 'photographer/my-info',
    order_list: _api_root + 'photographer/order-list',
    access_order: _api_root + 'photographer/access-order',
    index: _api_root + 'photographer/index',
    add_price:_api_root+'photographer/add-price',
    update_location:_api_root+'photographer/update-location',
    add_label: _api_root +'photographer/add-label',
    hide_location:_api_root+'photographer/hide-location',
    msg:_api_root+'photographer/msg',
    can_down: _api_root + 'photographer/can-down',
  },
  requirement: {
    type_list: _api_root + 'requirement/requirement-types',
    area_photographer: _api_root + "requirement/area-photographer",
    get_price: _api_root + 'requirement/get-price',
    submit_order: _api_root + 'requirement/submit-order',
    order_detail: _api_root + 'requirement/order-detail',
    pay_data: _api_root + 'requirement/pay-data',
    order_list: _api_root + 'requirement/order-list',
    confirm: _api_root + 'requirement/confirm',
    add_price:_api_root+'requirement/add-price',
    area_order: _api_root + 'requirement/area-order',
    download:_api_root+'requirement/download'
  },
  ...
  user: {
    cash_detail: _api_root + 'user/cash-detail',
    apply: _api_root + 'user/apply',
    get_price: _api_root + 'user/get-price',
    address_list: _api_root + 'user/address-list',
    wallet_detail: _api_root + 'user/wallet-detail',
    ...
    msg_list:_api_root+'user/msg-list'

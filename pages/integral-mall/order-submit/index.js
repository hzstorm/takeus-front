...
Page({
    ...
    onShow: function () {
        ...
        app.request({
            ...
            data: {
                goods_info: page.data.goods_info,
            ...
            success: function (res) {
                ...
                if (res.code == 0) {
                    ...
                    var total_price = parseFloat(page.data.attr_price) + parseFloat(res.data.express_price)
    ...
    getOffline: function (e) {
        ...
        if (offline == 1) {
            ...
            var total_price2 = parseFloat(total_price - express).toFixed(2);
            page.setData({
                offline: 2,
 ...
 */
    ...
    orderSubmit: function (e) {
        ...
        if (page.data.goods_info) {
            var attr = page.data.goods_info.attr
            var googs_attr = [];
            for (var i in attr) {
                var attrs = {

...
Page({
  data: {
    ...
    unread_count: 0,
    show_msg: true,
    photographer_img: '/images/mylocation_blue.png',
    user_img: '/images/mylocation_blue.png',
    markers: []
  },
  user: function(e) {
    wx.navigateTo({
  ...
  msg: function(e) {
    wx.navigateTo({
      url: '/pages/photographer/message/index/index',
    })
    ...
    app.request({
      ...
      success: function(res) {
        if (res.code == 0) {
          ...
          var is_phptographer = page.data.user_info.is_photographer;
          if (is_phptographer == 0) {
            wx.showModal({
              title: '提示',
              content: '你不是摄影师',
              success: function(e) {
    ...
    wx.getLocation({
      success: function(res) {
        ...
        var marker = {
          ...
          iconPath: '/images/mylocation_blue.png',
          width: 40,
          height: 40,
